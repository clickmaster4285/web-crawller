  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Catalogue gaps — Parity" },
      {
        ...
        content:
          "Category and brand coverage gaps between your catalogue and the market.",
      },
    ],
  }),
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {b.you === 0 ? "You stock none" : `You stock ${b.you}`} ·
                    market {b.competitors}
                  </p>
                </div>
